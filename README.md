...
|---|---|---|---|
| **RANK 04** |
|[C++ modules](https://github.com/marianaobmorais/cpp)| C++ language, Makefile | Object-Oriented Programming  | The objective of these modules is to give an introduction to Object-Oriented Programming. In order to keep things simple, the modules follow the C++98 standard. |
